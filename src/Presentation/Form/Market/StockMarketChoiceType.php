...
class StockMarketChoiceType extends AbstractType implements DataTransformerInterface
{
    ...
    public function __construct(ProjectionStockMarketRepositoryInterface $marketRepository, RouterInterface $resolver)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addModelTransformer(
            new ChoiceToStockMarketTransformer($this->marketRepository)
        );
    }
